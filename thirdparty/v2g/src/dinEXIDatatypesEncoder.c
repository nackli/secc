...
//ygq			if ( dinPhysicalValueType->Unit_isUsed == 1u ) {
			if ( 1 ) {
				errn = encodeNBitUnsignedInteger(stream, 2, 0);
				if(errn == 0) {
					/* FirstStartTag[CHARACTERS[ENUMERATION]] */
